...
const AddDelete = (props) => {
  return(
    <div>
      <button type='button' className="btn btn-secondary" style={{marginRight: 10}} onClick={props.AddRow}>
        Add Item
      </button> 
      <button type='button' className="btn btn-danger" onClick={() => props.RemoveRow(props.name, props.obj)} disabled={props.Disable(props.obj)}>
        Delete
      </button>
    </div>
  )
...
{/* customer name */}
          <FormRow label='Customer Info.'>
            ...
            <div className='form-inline'>
              <small className='text-muted'>*Fill in either Name, Organization or Both</small>
            </div>
          </FormRow>         
{/* project selling */}
              ...
              <table className="table-borderless" id="tab_logic">
                ...
                <tfoot className='border-width'> 
                  <tr style={{height: 47}}>
                    <td/>
                    <td>
                      <button type='button' className='btn btn-primary btn-block' onClick={this.CalculateTotalCost}>
                        Calculate
                      </button>
                    </td>
                    <td>
